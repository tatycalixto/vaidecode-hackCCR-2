          ...
          <div class="row">
            <div class="col-md-6">
              <div class="count-area-content">
                ...
                <div class="count-title">Jovens Alcançados</div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="count-area-content">
                <div class="count-digit">1000</div>
                <div class="count-title">Jovens Empregados</div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="count-area-content">
                <div class="count-digit">500</div>
                <div class="count-title">Empresas Parceiras</div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="count-area-content">
                <div class="count-digit">100</div>
                <div class="count-title">Instituições Parceiras</div>
              </div>
            </div>
          </div>
        </div>
